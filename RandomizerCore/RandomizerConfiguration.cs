...
public sealed partial class RandomizerConfiguration : INotifyPropertyChanged
{
    ...
    public bool palaceDropStyleIsIncluded() => palaceStylesAreNotAllVanillaOrShuffled();
    ...
    public RandomizerProperties Export(Random r)
    {
        ...
        {
            var keys = Enum.GetValues<Biome>().Where(b => b.IsWestBiome());
        ...
        {
            var keys = Enum.GetValues<Biome>().Where(b => b.IsEastBiome());
        ...
        {
            var keys = Enum.GetValues<Biome>().Where(b => b.IsDmBiome());
