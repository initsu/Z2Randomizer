...
{
    [Description("Short; [45% to 65%]"), RandomRangeDouble(Low = 0.45, High = 0.70)]
    SHORT = 0,
    ...
    FULL = 2, // is not rolled for Vanilla palaces
    [Description("Random; [45% to 115%]"), RandomRangeDouble(Low = 0.45, High = 1.15)]
    RANDOM = 3
}
